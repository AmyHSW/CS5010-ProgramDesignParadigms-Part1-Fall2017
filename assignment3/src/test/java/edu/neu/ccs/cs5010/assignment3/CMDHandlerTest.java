...
/**
 * The <code>CMDHandlerTest</code> is a test class for <code>CMDHandler</code>.
 *
 * @author Shuwan Huang
 */
public class CMDHandlerTest {
  ...
  /**
   * Tests that getEvent returns the correct event details.
   */
  @Test
  public void getEvent() throws Exception {
    assertTrue(legalArguments1.getEvent().equals("arrival"));
    assertTrue(legalArguments2.getEvent().equals("arrival"));
    assertTrue(illegalArguments1.getEvent() == null);
    assertTrue(illegalArguments2.getEvent() == null);
  }

  /**
   * Tests that getMode returns the correct mode, or returns 1 if mode is not provided by user.
   */
  @Test
  public void getMode() throws Exception {
    assertTrue(legalArguments1.getMode() == 1);
    assertTrue(legalArguments2.getMode() == 2);
    assertTrue(illegalArguments1.getMode() == 1);
    assertTrue(illegalArguments2.getMode() == 1);
  }
}