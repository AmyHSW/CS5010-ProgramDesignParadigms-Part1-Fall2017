...
public interface IPriorityQueue<E> {
  ...
  /**
   * Returns a list that contains contents in the priority queue in the order from highest
   * priority to lowest.
   * @return a list that contains contents in the priority queue in the order from highest
   * priority to lowest.
   */
