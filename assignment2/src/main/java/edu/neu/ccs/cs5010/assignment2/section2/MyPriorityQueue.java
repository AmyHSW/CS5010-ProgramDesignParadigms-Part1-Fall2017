 ...
 * <p>
 * <code>MyPriorityQueue</code> supports inserting elements to the queue with O(lgN) time,
 * removing the head element from the priority queue with O(lgN) time, and returning the
 * head element with O(1) time. It also supports checking if the priority queue is empty,
 * and can return list that contains all elements in queue either in ascending order of
 * priority or in descending order.
 *
...
public class MyPriorityQueue<E extends Comparable<E>> implements IPriorityQueue<E> {
  ...
  /**
   * Returns a list that contains contents in the priority queue in the order from
   * highest priority to lowest.
   * @return a list that contains contents in the priority queue in the order from
   * highest priority to lowest.
   */
  ...
  /**
   * Returns a list that contains contents in the priority queue in the order
   * from lowest priority to highest.
   * @return a list that contains contents in the priority queue in the order
   * from lowest priority to highest.
   */
