 ...
 * When a patient is sent to this room, it will increase the busy time of this room by
 * the treat time of patient, and increment the number of patients treated in this room by one.
 * <p>
 * The natural ordering of examination rooms is by the busy time. The room with less
 * busy time has higher priority to accept new patient.
 *
 * @author Shuwan Huang
 */
public class ExaminationRoom implements IExaminationRoom {
   ...
   * @return a negative integer if this examination room is less busy than the other;
   *         the value 0 if they are equally busy; a positive integer if this
   *         examination room is busier than the other.
   */
