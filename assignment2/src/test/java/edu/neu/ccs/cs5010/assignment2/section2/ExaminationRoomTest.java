...
public class ExaminationRoomTest {
  ...
  public void testEquals() throws Exception {
    ...
    IExaminationRoom other2 = new ExaminationRoom();
    other2.addBusyTime(Duration.ofMinutes(10));

    assertTrue("equals does not return true for equal rooms", room.equals(other));
    assertTrue("equals returns true when compare to null", !room.equals(null));
    assertTrue("equals returns true when compare to other class",
               !room.equals(new Urgency(1)));
    assertTrue("equals returns true when compare to diffent room",
               !room.equals(other2));
  }
  ...
  public void testHashCode() throws Exception {
    ...
    assertTrue("equal rooms should have the same hash code",
               room.hashCode() == other.hashCode());
  }
