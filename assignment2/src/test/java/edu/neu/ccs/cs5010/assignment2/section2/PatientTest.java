...
public class PatientTest {
  ...
  public void setUp() throws Exception {
    ...
    patient = new Patient(arrival, new Urgency(3), treatTime, id);
  }
  ...
  public void testGetUrgencyLevel() throws Exception {
    assertEquals("urgency level should be 3 but it isn't", 3, patient.getUrgency().getLevel());
  }
  ...
  public void testCompareToForEqualUrgency() throws Exception {
    Patient other = new Patient(arrival.plusMinutes(20), new Urgency(3), treatTime, id);
  ...
  public void testCompareToForEqualArrival() throws Exception {
    Patient other = new Patient(arrival, new Urgency(5), treatTime, id + 1);
  ...
  public void testThrowsInvalidUrgencyLevelException() throws Exception {
    IPatient other = new Patient(arrival, new Urgency(0), treatTime, id + 1);
  }
  ...
  public void testThrowsIllegalArgumentExceptionForNullArrival() throws Exception {
    IPatient other = new Patient(null, new Urgency(3), treatTime, id);
  }
  ...
  public void testThrowsIllegalArgumentExceptionForNullTreatment() throws Exception {
    IPatient other = new Patient(arrival, new Urgency(3), null, id);
  }
  ...
  public void testEquals() throws Exception {
    ...
    IPatient other = new Patient(arrival, new Urgency(3), treatTime, id);
  ...
  public void testEqualsOnDifferentUrgency() throws Exception {
    IPatient other = new Patient(arrival, new Urgency(4), treatTime, id);
  ...
  public void testEqualsOnDifferentArrival() throws Exception {
    IPatient other = new Patient(arrival.minusMinutes(10), new Urgency(3), treatTime, id);
    assertTrue("equals returns true for different patients", !patient.equals(other));
  }
  ...
  public void testEqualsOnDifferentTreatTime() throws Exception {
    IPatient other = new Patient(arrival, new Urgency(3), treatTime.plusMinutes(5), id);
    assertTrue("equals returns true for different patients", !patient.equals(other));
  }
